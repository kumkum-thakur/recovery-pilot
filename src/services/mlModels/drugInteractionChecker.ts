...
const DRUG_DATABASE: DrugEntry[] = [
  { id: 'morphine', name: 'Morphine', genericName: 'morphine sulfate', category: DrugCategory.OPIOID_ANALGESIC, cyp450Substrates: ['UGT2B7'], cyp450Inhibitors: [], cyp450Inducers: [], commonDoseForms: ['IV', 'oral', 'IM'], halfLifeHours: 3 },
  ...
  { id: 'hydromorphone', name: 'Dilaudid', genericName: 'hydromorphone', category: DrugCategory.OPIOID_ANALGESIC, cyp450Substrates: ['UGT2B7'], cyp450Inhibitors: [], cyp450Inducers: [], commonDoseForms: ['IV', 'oral'], halfLifeHours: 2.5 },
  ...
  { id: 'ciprofloxacin', name: 'Cipro', genericName: 'ciprofloxacin', category: DrugCategory.ANTIBIOTIC, cyp450Substrates: [], cyp450Inhibitors: ['CYP1A2'], cyp450Inducers: [], commonDoseForms: ['oral', 'IV'], halfLifeHours: 4 },
  ...
  { id: 'omeprazole', name: 'Prilosec', genericName: 'omeprazole', category: DrugCategory.PPI, cyp450Substrates: ['CYP2C19', 'CYP3A4'], cyp450Inhibitors: ['CYP2C19'], cyp450Inducers: [], commonDoseForms: ['oral'], halfLifeHours: 1 },
  ...
  { id: 'escitalopram', name: 'Lexapro', genericName: 'escitalopram', category: DrugCategory.ANTIDEPRESSANT, cyp450Substrates: ['CYP3A4', 'CYP2C19'], cyp450Inhibitors: [], cyp450Inducers: [], commonDoseForms: ['oral'], halfLifeHours: 30 },
...
const INTERACTION_DATABASE: InteractionPair[] = [
  ...
  { drugA: 'fentanyl', drugB: 'midazolam', severity: InteractionSeverity.MAJOR, mechanism: InteractionMechanism.ADDITIVE_RESPIRATORY_DEPRESSION, description: 'High-potency opioid combined with benzodiazepine carries significant risk of respiratory depression. Routinely used in monitored anesthesia/procedural sedation under continuous monitoring.', clinicalRecommendation: 'Avoid concurrent use outside of monitored settings. In procedural sedation, ensure continuous monitoring, capnography, and reversal agents (naloxone, flumazenil) available.', evidenceLevel: 'FDA Black Box Warning', baseSeverityScore: 0.9 },
  ...
  // SSRI + NSAID bleeding
  { drugA: 'sertraline', drugB: 'ibuprofen', severity: InteractionSeverity.MODERATE, mechanism: InteractionMechanism.ADDITIVE_BLEEDING_RISK, description: 'SSRIs impair platelet serotonin uptake. Combined with NSAID antiplatelet effect, GI bleeding risk increases 3-6 fold.', clinicalRecommendation: 'Add PPI for GI protection. Monitor for signs of bleeding. Use acetaminophen if possible.', evidenceLevel: 'Level A', baseSeverityScore: 0.6 },
