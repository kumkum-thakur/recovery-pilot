...
const FORMULARY_DATABASE: FormularyDrug[] = [
  ...
  { name: 'metronidazole', genericName: 'metronidazole', brandNames: ['Flagyl'], rxnormCode: '6922', ndcCodes: ['00093-0812-01'], drugClass: DrugClass.ANTIBIOTIC_PENICILLIN, tier: FormularyTier.TIER_1_GENERIC, priorAuthRequired: false, stepTherapyRequired: false, copayRange: { min: 4, max: 12 }, isGeneric: true, isControlled: false, therapeuticAlternatives: ['vancomycin oral'], route: 'oral', commonDosages: ['250mg', '500mg'] },
  { name: 'vancomycin', genericName: 'vancomycin', brandNames: ['Vancocin'], rxnormCode: '11124', ndcCodes: ['00049-0570-83'], drugClass: DrugClass.ANTIBIOTIC_PENICILLIN, tier: FormularyTier.TIER_3_NON_PREFERRED, priorAuthRequired: true, stepTherapyRequired: false, copayRange: { min: 50, max: 200 }, isGeneric: true, isControlled: false, therapeuticAlternatives: ['metronidazole'], route: 'oral/IV', commonDosages: ['125mg oral', '250mg oral', '1g IV'] },
  { name: 'clindamycin', genericName: 'clindamycin', brandNames: ['Cleocin'], rxnormCode: '2582', ndcCodes: ['00009-0331-02'], drugClass: DrugClass.ANTIBIOTIC_MACROLIDE, tier: FormularyTier.TIER_1_GENERIC, priorAuthRequired: false, stepTherapyRequired: false, copayRange: { min: 5, max: 15 }, isGeneric: true, isControlled: false, therapeuticAlternatives: ['amoxicillin/clavulanate'], route: 'oral', commonDosages: ['150mg', '300mg'] },
  { name: 'sulfamethoxazole/trimethoprim', genericName: 'sulfamethoxazole/trimethoprim', brandNames: ['Bactrim', 'Septra'], rxnormCode: '10180', ndcCodes: ['00781-5756-01'], drugClass: DrugClass.ANTIBIOTIC_PENICILLIN, tier: FormularyTier.TIER_1_GENERIC, priorAuthRequired: false, stepTherapyRequired: false, copayRange: { min: 4, max: 10 }, isGeneric: true, isControlled: false, therapeuticAlternatives: ['ciprofloxacin'], route: 'oral', commonDosages: ['400/80mg', '800/160mg'] },
  { name: 'linezolid', genericName: 'linezolid', brandNames: ['Zyvox'], rxnormCode: '190376', ndcCodes: ['00009-5140-01'], drugClass: DrugClass.ANTIBIOTIC_PENICILLIN, tier: FormularyTier.TIER_4_SPECIALTY, priorAuthRequired: true, stepTherapyRequired: true, copayRange: { min: 100, max: 500 }, isGeneric: true, isControlled: false, therapeuticAlternatives: ['vancomycin'], route: 'oral/IV', commonDosages: ['600mg'] },
  ...
  { name: 'montelukast', genericName: 'montelukast', brandNames: ['Singulair'], rxnormCode: '88249', ndcCodes: ['00006-0117-31'], drugClass: DrugClass.BRONCHODILATOR, tier: FormularyTier.TIER_1_GENERIC, priorAuthRequired: false, stepTherapyRequired: false, copayRange: { min: 4, max: 15 }, isGeneric: true, isControlled: false, therapeuticAlternatives: ['zafirlukast'], route: 'oral', commonDosages: ['4mg', '5mg', '10mg'] },
