...
Given the healthcare nature of this project, contributors must also:

- **Never** include real patient data in code, tests, documentation, issues, or pull requests
- Use only synthetic or generated data for all examples and testing
- Follow HIPAA-equivalent data handling practices in all contributions
- Report any accidental inclusion of real clinical data or PII immediately to a maintainer
